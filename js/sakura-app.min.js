...
function code_highlight_style() {
    function e(e) {
        ...
        if ("hljs" == (a = o.substr(0, o.indexOf(" ")).replace("language-", "")).toLowerCase()) var a = $("pre:eq(" + e + ") code").attr("class").replace("hljs", "") ? $("pre:eq(" + e + ") code").attr("class").replace("hljs", "") : "text";
...
mashiro_global.variables = new function() {
    this.has_hls = !1, this.skinSecter = !0
}, mashiro_global.ini = new function() {
    this.normalize = function() {
        lazyload(), social_share(), post_list_show_animation(), copy_code_block(), coverVideoIni(), checkskinSecter(), scrollBar(), load_bangumi()
    }, this.pjax = function() {
        pjaxInit(), social_share(), post_list_show_animation(), copy_code_block(), coverVideoIni(), checkskinSecter(), load_bangumi()
    }
    ...
    $("#upload-img-file").change((function() {
        ...
        for (var t = 0; t < this.files.length; t++) {
            ...
            a.append("cmt_img_file", o), $.ajax({
                ...
                success: function(t) {
                    if (e.html('<i class="fa fa-check" aria-hidden="true"></i>'), setTimeout((function() {
                            e.html('<i class="fa fa-picture-o" aria-hidden="true"></i>')
                        }), 1e3), 200 == t.status) {
                        var a = t.proxy;
                        $("#upload-img-show").append('<img class="lazyload upload-image-preview" src="https://cdn.jsdelivr.net/gh/moezx/cdn@3.0.2/img/svg/loader/trans.ajax-spinner-preloader.svg" data-src="' + a + '" onclick="window.open(\'' + a + '\')" onerror="imgError(this)" />'), lazyload(), addComment.createButterbar("图片上传成功~<br>Uploaded successfully~"), grin(a, type = "Img")
                    } else addComment.createButterbar("上传失败！<br>Uploaded failed!<br> 文件名/Filename: " + o.name + "<br>code: " + t.status + "<br>" + t.message, 3e3)
                },
...
function checkDarkModeCookie() {
    var e = getCookie("dark"),
        t = (new Date).getHours();
    mashiro_option.darkmode && (!e && (t > 21 || t < 7) || "1" == e && (t >= 22 || t <= 6)) ? (setTimeout((function() {
        $("#dark-bg").click()
    }), 100), $("#moblieDarkLight").html('<i class="fa fa-sun-o" aria-hidden="true"></i>')) : document.body.clientWidth > 860 ? setTimeout((function() {
        checkBgImgCookie()
    }), 100) : ($("html").css("background", "unset"), $("body").removeClass("dark"), $("#moblieDarkLight").html('<i class="fa fa-moon-o" aria-hidden="true"></i>'), setCookie("dark", "0", .33))
}

function mobile_dark_light() {
    $("body").hasClass("dark") ? ($("html").css("background", "unset"), $("body").removeClass("dark"), $("#moblieDarkLight").html('<i class="fa fa-moon-o" aria-hidden="true"></i>'), setCookie("dark", "0", .33)) : ($("html").css("background", "#31363b"), $("#moblieDarkLight").html('<i class="fa fa-sun-o" aria-hidden="true"></i>'), $("body").addClass("dark"), setCookie("dark", "1", .33))
}
...
})), click_to_view_image(), original_emoji_click(), !getCookie("darkcache") && ((new Date).getHours() > 21 || (new Date).getHours() < 7) && (removeCookie("dark"), setCookie("darkcache", "cached", .4)), setTimeout((function() {
    checkDarkModeCookie()
...
function timeSeriesReload(e) {
    ...
    1 == e ? (t.find("span.al_mon").click((function() {
        ...
        $("#al_expand_collapse,#archives span.al_mon").css({
            cursor: "s-resize"
        }), t.find("span.al_mon").each((function() {
            var e = $(this).next().children("li").length;
            $(this).children("#post-num").text(e)
        }));
        var e = t.find("ul.al_post_list"),
            o = t.find("ul.al_post_list:first");
        e.hide(1, (function() {
            o.show()
        ...
        $("#al_expand_collapse").click((function() {
            0 == a ? (e.each((function(e) {
                var t = $(this);
                setTimeout((function() {
                    t.show(400)
                }), 50 * e)
            })), a++) : 1 == a && (e.each((function(e) {
                var t = $(this);
                setTimeout((function() {
                    t.hide(400)
                }), 50 * e)
...
function coverVideo() {
    var e = addComment.I("coverVideo"),
        t = addComment.I("coverVideo-btn");
    if (e.paused) {
        e.play();
        try {
...
function coverVideoIni() {
    $("video").hasClass("hls") && (mashiro_global.variables.has_hls ? loadHls() : $.getScript("https://cdn.jsdelivr.net/gh/mashirozx/Sakura@3.3.3/cdn/js/src/16.hls.js", (function() {
        loadHls(), mashiro_global.variables.has_hls = !0
    })))
}
...
function copy_code_block() {
    $("pre code").each((function(e, t) {
        $(t).attr({
            id: "hljs-" + e
        }), $(this).after('<a class="copy-code" href="javascript:" data-clipboard-target="#hljs-' + e + '" title="拷贝代码"><i class="fa fa-clipboard" aria-hidden="true"></i></a>')
    }));
...
function tableOfContentScroll(e) {
    if (!(document.body.clientWidth <= 1200))
        if (0 == $("div").hasClass("have-toc") && 0 == $("div").hasClass("has-toc")) $(".toc-container").remove();
        else if (e) {
        var t = 1,
            o = "sakura" == mashiro_option.entry_content_theme ? $("article").hasClass("type-post") ? $("div").hasClass("pattern-attachment-img") ? -75 : 200 : 375 : window.innerHeight / 2;
...
function grin(e, t, o, a) {
    ...
    if (i = addComment.I("comment"), document.selection) i.focus(), sel = document.selection.createRange(), sel.text = e, i.focus();
...
function add_copyright() {
    document.body.addEventListener("copy", (function(e) {
        window.getSelection().toString().length > 30 && mashiro_option.clipboardCopyright && function(e) {
            e.preventDefault();
            var t = "# For commercial use, please contact the author for authorization. For non-commercial use, please indicate the source.<br># License：4.0 (CC BY-NC-SA 4.0)<br># Author：1337eng" + "<br># URL：" + window.location.href + "<br># Source：" + "https://1337eng.tech" + "<br><br>" + window.getSelection().toString().replace(/\r\n/g, "<br>"),
                o = "# For commercial use, please contact the author for authorization. For non-commercial use, please indicate the source.\n# License：4.0 (CC BY-NC-SA 4.0)\n# Author： 1337eng" + "\n# URL：" + window.location.href + "\n# Source：" + "https://1337eng.tech" + "\n\n" + window.getSelection().toString().replace(/\r\n/g, "\n");
            if (e.clipboardData) e.clipboardData.setData("text/html", t), e.clipboardData.setData("text/plain", o);
            else if (window.clipboardData) window.clipboardData.setData("text", o)
        }(e), addComment.createButterbar("Copied to clipboard successfully!", 1e3)
    }))
}
if ($(document).on("click", ".sm", (function() {
        1 == confirm("Are you sure you want to make it private?") ? $(this).commentPrivate() : alert("Cancelled")
    })), $.fn.commentPrivate = function() {
        if ($(this).hasClass("private_now")) return alert("You have previously set a private comment"), !1;
        $(this).addClass("private_now");
        var e = $(this).data("idp"),
            t = $(this).data("actionp"),
            o = $(this).children(".has_set_private"),
            a = {
    ...
    function aplayerF() {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            function t(t, o) {
                ...
                var l = 0;
                $(".aplayer.aplayer-fixed .aplayer-body").addClass("ap-hover"), $(".aplayer-miniswitcher").click((function() {
                    0 == l ? ($(".aplayer.aplayer-fixed .aplayer-body").removeClass("ap-hover"), $("#secondary").addClass("active"), l = 1) : ($(".aplayer.aplayer-fixed .aplayer-body").addClass("ap-hover"), $("#secondary").removeClass("active"), l = 0)
                }))
            }
            var o = mashiro_option.meting_api_url + "?server=:server&type=:type&id=:id&_wpnonce=" + Poi.nonce;
            ...
            for (var i = document.querySelectorAll(".aplayer"), n = function() {
                    ...
                    if (e.dataset.id) {
                        ...
                        a = (a = (a = a.replace(":server", e.dataset.server)).replace(":type", e.dataset.type)).replace(":id", e.dataset.id);
...
function activate_widget() {
    document.body.clientWidth > 860 ? $(".show-hide").on("click", (function() {
        $("#secondary").toggleClass("active")
    })) : $("#secondary").remove()
}

function load_bangumi() {
    $("section").hasClass("bangumi") && $("body").on("click", "#bangumi-pagination a", (function() {
        $("#bangumi-pagination a").addClass("loading").text("");
        var e = new XMLHttpRequest;
        return e.open("POST", this.href + "&_wpnonce=" + Poi.nonce, !0), e.onreadystatechange = function() {
            if (4 == e.readyState)
                if (200 == e.status) {
                    var t = JSON.parse(e.responseText);
                    $("#bangumi-pagination").remove(), $(".row").append(t)
                } else $("#bangumi-pagination a").removeClass("loading").html('<i class="fa fa-exclamation-triangle" aria-hidden="true"></i> ERROR ')
        }, e.send(), !1
    }))
}
setTimeout((function() {
        activate_widget()
    }), 100), mashiro_global.ini.normalize(), loadCSS(mashiro_option.jsdelivr_css_src), loadCSS(mashiro_option.entry_content_theme_src), loadCSS("https://at.alicdn.com/t/font_679578_qyt5qzzavdo39pb9.css"), loadCSS("https://cdn.jsdelivr.net/npm/aplayer@1.10.1/dist/APlayer.min.css"), loadCSS("https://fonts.googleapis.com/css?family=Noto+SerifMerriweather|Merriweather+Sans|Source+Code+Pro|Ubuntu:400,700|Noto+Serif+SC"),
    function(e, t) {
    ...
    Siren = {
        MN: function() {
            $(".iconflat").on("click", (function() {
                $("body").toggleClass("navOpen"), $("#main-container,#mo-nav,.openNav").toggleClass("open")
            }))
        },
        MNH: function() {
        ...
        splay: function() {
            $("#video-btn").addClass("video-pause").removeClass("video-play").show(), $(".video-stu").css({
                bottom: "-100px"
            }), $(".focusinfo").css({
                top: "-999px"
            });
        ...
        spause: function() {
            $("#video-btn").addClass("video-play").removeClass("video-pause"), $(".focusinfo").css({
                top: "49.3%"
            }), s.pause()
        },
        liveplay: function() {
        ...
        livepause: function() {
            null != s.oncanplay && $(".haslive").length > 0 && (Siren.spause(), $(".video-stu").css({
                bottom: "0px"
            }).html("已暂停 ..."))
        },
        addsource: function() {
        ...
        LV: function() {
            ...
            e.on("click", (function() {
                ...
                }) : $(this).hasClass("video-pause") ? (Siren.spause(), e.removeClass("videolive"), $(".video-stu").css({
                    bottom: "0px"
                }).html("已暂停 ...")) : (Siren.splay(), e.addClass("videolive")), s.onended = function() {
                    $("#bgvideo").attr("src", ""), $("#video-add").hide(), e.addClass("loadvideo").removeClass("video-pause").removeClass("videolive").removeClass("haslive"), $(".focusinfo").css({
                        top: "49.3%"
                    })
                }
        ...
        AH: function() {
            if ("auto" == Poi.windowheight && "auto" == mashiro_option.windowheight) {
        ...
        PE: function() {
            $(".headertop").length > 0 && ($("h1.main-title").length > 0 ? ($(".blank").css({
                "padding-top": "0px"
            }), $(".headertop").css({
                height: "auto"
            }).show(), "open" == Poi.movies.live && Siren.liveplay()) : ($(".blank").css({
                "padding-top": "75px"
            }), $(".headertop").css({
                height: "0px"
            }).hide(), Siren.livepause()))
        },
        CE: function() {
            $(".comments-hidden").show(), $(".comments-main").hide(), $(".comments-hidden").click((function() {
                ...
                if ($(".js-toggle-search").toggleClass("is-active"), $(".js-search").toggleClass("is-visible"), $("html").css("overflow-y", "hidden"), mashiro_option.live_search) {
                    var e = [];
                    ! function(a) {
                        if (null != sessionStorage.getItem("search")) s(e = JSON.parse(sessionStorage.getItem("search")), $("#search-input").val(), o), n();
                        else {
                    ...
                    }(Poi.api + "sakura/v1/cache_search/json?_wpnonce=" + Poi.nonce);
                    var t = addComment.I("search-input"),
                        o = addComment.I("PostlistBox").innerHTML,
                        a = null;
                    ...
                    function r(e, t, o, a, i, n, r) {
                        if (e) {
                            var s = e.trim().split(" "),
                                l = a.indexOf(s[s.length - 1]),
                                c = r.indexOf(s[s.length - 1]);
                    ...
                    function s(e, t, o) {
                        var a, n, s, l = "",
                            ...
                            h = "",
                            p = "",
                            f = '<section class="ins-section"><header class="ins-section-header">',
                            g = "</section>",
                            v = "</header>",
                            b = (n = e, s = (s = t.trim()).replace(s, "^(?=.*?" + s + ").+$").replace(/\s/g, ")(?=.*?"), i = n.filter((e => Object.values(e).some((e => new RegExp(s + "").test(e))))), i);
                        for (a = 0; a < Object.keys(b).length; a++) switch ((p = b[a]).type) {
                            case "post":
                                c += r(t, p.link, "file", p.title, "mark", p.comments, p.text);
                                break;
                            case "tag":
                                m += r("", p.link, "tag", p.title, "none", "", "");
                                break;
                            case "category":
                                u += r("", p.link, "folder", p.title, "none", "", "");
                                break;
                            case "page":
                                d += r(t, p.link, "file", p.title, "mark", p.comments, p.text);
                                break;
                            case "comment":
                                h += r(t, p.link, "comment", p.title, "none", "", p.text)
                        }
                        c && (l = l + f + "文章" + v + c + g), d && (l = l + f + "页面" + v + d + g), u && (l = l + f + "分类" + v + u + g), m && (l = l + f + "标签" + v + m + g), h && (l = l + f + "评论" + v + h + g), addComment.I("PostlistBox").innerHTML = l
                    }
                    t.oninput = function() {
        ...
        XLS: function() {
                ...
                return $("#pagination a").addClass("loading").text(""), $.ajax({
                    ...
                    success: function(e) {
                        if (result = $(e).find("#main .post"), nextHref = $(e).find("#pagination a").attr("href"), $("#main").append(result.fadeIn(500)), $("#pagination a").removeClass("loading").text("Previous"), $("#add_post span").removeClass("loading").text(""), lazyload(), post_list_show_animation(), null != nextHref) {
                            ...
                            $(window).scrollTop(t), $body.animate({
                                scrollTop: t + 100
                            }, 666)
                        } else $("#pagination").html("<span>I'm glad you got here, but it's really gone....</span>")
                    }
                }), !1
            }
            $body = window.opera ? "CSS1Compat" == document.compatMode ? $("html") : $("body") : $("html,body"), new IntersectionObserver((function(o) {
                if (!(o[0].intersectionRatio <= 0)) {
                    var a = $("#pagination a").attr("href"),
                        i = addComment.I("add_post_time");
                    if (null != a && i) {
                        var n = addComment.I("add_post_time").title;
                        "233" != n && (console.log("%c Automatic loading countdown %c", "background:#9a9da2; color:#ffffff; border-radius:4px;", "", "", n), e = setTimeout((function() {
                            t()
                        }), 1e3 * n))
                    }
                }
        ...
        XCS: function() {
            var e = jQuery("#cancel-comment-reply-link"),
                t = e.text(),
                o = "commentwrap";
            jQuery(document).on("submit", "#commentform", (function() {
                return jQuery.ajax({
                    ...
                    success: function(e) {
                        ...
                        var t = addComment,
                            a = t.I("cancel-comment-reply-link"),
                            i = t.I("wp-temp-form-div"),
                            n = t.I(t.respondId);
                ...
                moveForm: function(o, a, i) {
                    var n, r = this,
                        s = r.I(o),
                        l = r.I(i),
                        c = r.I("cancel-comment-reply-link"),
                    ...
                    }, 400), d.value = a, c.style.display = "", c.onclick = function() {
                        var e = addComment,
        ...
        XCP: function() {
            $body = window.opera ? "CSS1Compat" == document.compatMode ? $("html") : $("body") : $("html,body"), $("body").on("click", "#comments-navi a", (function(e) {
                e.preventDefault();
                var t = $(this)[0].pathname;
                $.ajax({
                    type: "GET",
                    url: $(this).attr("href"),
                    beforeSend: function() {
                        $("#comments-navi").remove(), $("ul.commentwrap").remove(), $("#loading-comments").slideDown(), $body.animate({
                            scrollTop: $("#comments-list-title").offset().top - 65
                        }, 800)
                    },
                    dataType: "html",
                    success: function(e) {
                        result = $(e).find("ul.commentwrap"), nextlink = $(e).find("#comments-navi"), $("#loading-comments").slideUp("fast"), $("#loading-comments").after(result.fadeIn(500)), $("ul.commentwrap").after(nextlink), lazyload(), window.gtag && gtag("config", Poi.google_analytics_id, {
                            page_path: t
                        }), code_highlight_style(), click_to_view_image()
                    }
                })
            }))
        },
        ...
        GT: function() {
            var e = document.body.clientWidth,
                ...
                o = document.querySelector(".cd-top"),
                a = document.querySelector("#moblieGoTop"),
                i = document.querySelector("#moblieDarkLight"),
                n = document.querySelector(".changeSkin-gear");
            $(window).scroll((function() {
                e <= 860 ? $(this).scrollTop() > 20 ? (a.style.transform = "scale(1)", i.style.transform = "scale(1)") : (a.style.transform = "scale(0)", i.style.transform = "scale(0)") : ($(this).scrollTop() > 100 ? (o.classList.add("cd-is-visible"), n.style.bottom = "0", o.style.top = t > 950 ? "0" : t - 950 + "px") : (n.style.bottom = "-999px", o.style.top = "-999px", o.classList.remove("cd-fade-out", "cd-is-visible")), $(this).scrollTop() > 1200 && o.classList.add("cd-fade-out"))
            })), o.onclick = function() {
                topFunction()
            }, a.onclick = function() {
                topFunction()
...
$((function() {
    Siren.AH(), Siren.PE(), Siren.NH(), Siren.GT(), Siren.XLS(), Siren.XCS(), Siren.XCP(), Siren.CE(), Siren.MN(), Siren.IA(), Siren.LV(), Poi.pjax && ($(document).pjax("a[target!=_top]", "#page", {
        ...
        window.gtag && gtag("config", Poi.google_analytics_id, {
        ...
        $(this).postLike()
    })), console.log("%c Mashiro %c", "background:#24272A; color:#ffffff", "", "Welcome to my place!")
}));
