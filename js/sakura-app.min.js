...
function add_copyright() {
    document.body.addEventListener("copy", (function(e) {
        window.getSelection().toString().length > 30 && mashiro_option.clipboardCopyright && function(e) {
            e.preventDefault();
            var t = "# For commercial use, please contact the author for authorization. For non-commercial use, please indicate the source.<br># License：4.0 (CC BY-NC-SA 4.0)<br># Author)：" + mashiro_option.author_name + "<br># URL：" + window.location.href + "<br># Source：" + mashiro_option.site_name + "<br><br>" + window.getSelection().toString().replace(/\r\n/g, "<br>"),
